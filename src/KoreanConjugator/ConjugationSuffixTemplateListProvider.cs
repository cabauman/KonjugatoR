...
public class ConjugationSuffixTemplateListProvider
{
    private static readonly Dictionary<(Tense, Formality, ClauseType), string> Map = new()
    {
        ...
        { (Tense.Past,      Formality.InformalHigh,     ClauseType.Declarative),      "어,요" },
        { (Tense.Past,      Formality.InformalHigh,     ClauseType.Imperative),       "," },
        { (Tense.Past,      Formality.InformalHigh,     ClauseType.Interrogative),    "어,요?" },
        ...
        { (Tense.Future,    Formality.InformalHigh,     ClauseType.Declarative),      "예,요" },
        { (Tense.Future,    Formality.InformalHigh,     ClauseType.Imperative),       "," },
        { (Tense.Future,    Formality.InformalHigh,     ClauseType.Interrogative),    "예,요?" },
